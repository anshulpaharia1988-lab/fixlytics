...
interface ScanScreenProps {
  url: string;
  onDone: (data: AuditData | null) => void;
}
...
export default function ScanScreen({ url, onDone }: ScanScreenProps) {
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 60% 50% at 50% 30%, rgba(0,199,88,0.18), transparent 70%)",
        }}
      />
      {/* grid */}
      <div
        style={{
          ...
          maskImage:
            "radial-gradient(ellipse 50% 50% at 50% 50%, #000 0%, transparent 80%)",
          WebkitMaskImage:
            "radial-gradient(ellipse 50% 50% at 50% 50%, #000 0%, transparent 80%)",
        }}
      />
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(0,199,88,0.45), rgba(10,22,40,0))",
            }}
          />
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "conic-gradient(from 0deg, rgba(0,199,88,0.7) 0deg, rgba(0,199,88,0) 90deg)",
              animation: "pc-spin 2.4s linear infinite",
              maskImage:
                "radial-gradient(circle, transparent 30%, #000 31%, #000 100%)",
              WebkitMaskImage:
                "radial-gradient(circle, transparent 30%, #000 31%, #000 100%)",
            }}
          />
        ...
        >
          We're going through your homepage step by step. This usually takes
          about 90 seconds.
        </p>
